...
Asena.addCommand({on: 'text', fromMe: false }, (async (message, match) => {
    if(Config.BGMFILTER){
        ...
        if (!!message.mention && message.mention[0] == '919847731535@s.whatsapp.net') {
...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '919847731535@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/manseion.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
const array = ['Elsa','Di','Sed','Friend','Kannappi','Group','Single','Alamb','owner','Jihad','Nanban','mone','Song','Pm','Bgm','Nidhin','Moodesh','chunk','Chunk','Thyr','Ok bie','Enthada','help','Adi','Anthas','Boss','Pubg','Free Fire','Kali','Ajith','Alo','Neymar','Kaztro','mention','Da','Name','Shahul','bot','song','hlo','Hlo','power','love','Lub','message','myre','mess','power','love','Lub','message','myre','Alla','mess','menu','Ara','ara','Ayin','movie','mathi','Good night','okku','Ombi','over','Phaa','Podi','setta','vazha','vedi','Vijay','Ah','ano','Arumille','Dance','dey','Etha','Good morning','good night','group','Hy','Ivan','Kando','kannappi','life','Mandan','one','vazha','vanno','Vala','thanks','Super','Song2','Song1','sheri','Reels','rasam','Psycho','Pwr','Poyi','pottan','Poli','pokko','poda','Pattumo','Allu','ammayi','Bolo','Call','colage','da','daa','edapoda','halo','hi','iblees','jab','janmam','kaki','kumu','kuree','kureee','Love','meen','my','naa','namaskaram','name','nari','otti','peru','pubjii','putt','Rani','sex','road','Sulaiman','Theerumbo','Ummer','Unda','Vali','Hi']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
...
const array = ['account poyi','Don','Eee','Good Morning','Hm','offer','poda myre','powli','romantic','sed','song','spam','Ha','Eda','ElsaMwol','Friend','group','Happy','help','Hi','Hlo','jihad','Kali','Kalikkuno','Kundan','Myra','Nanba','nanban','Ntha','Ok','para','photo','poda','really','song','sticker','tha','Thund','Va','Vazhe','video','You','Ajith']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['Alone','avan','Bot','Da','Di','Enthada','friends','Jihad','Life','love','lub','M','Mm','Myr','Myre','Nice','Ningal','Njan','Owner','Para','Please','Poda','pro','Sathyam','Thep','Umm','umma','venda','xxx','Bomb','hi','hii','muba','mubi','Mubashir','Pover']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
