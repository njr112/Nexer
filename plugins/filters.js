...
const array = ['account poyi','Don','Eee','Good Morning','Hm','offer','poda myre','powli','romantic','sed','song','spam','Ha','Eda','ElsaMwol','Friend','group','Happy','help','Hi','Hlo','jihad','Kali','Kalikkuno','Kundan','Myra','Nanba','nanban','Ntha','Ok','para','photo','poda','really','song','sticker','tha','Thund','Va','Vazhe','video','You','Allu','ammayi','Bolo','Call','colage','da','daa','edapoda','halo','hi','iblees','jab','janmam','kaki','kumu','kuree','kureee','Love','meen','my','naa','namaskaram','name','nari','otti','peru','pubjii','putt','Rani','sex','road','Sulaiman','Theerumbo','Ummer','Unda','Vali']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
